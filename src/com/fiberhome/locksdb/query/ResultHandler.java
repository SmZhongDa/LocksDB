...
public class ResultHandler extends LocksQuery implements Runnable {
	private static Logger logger = LoggerFactory.getLogger(ResultHandler.class);
	private RocksQuery query = null;
	...
	public ResultHandler(CountDownLatch latch, RocksQuery query, LinkedBlockingQueue<byte[]> result, LinkedList<Pair<String, Integer>> index, LinkedBlockingQueue<String> response, String rid) {
		super(rid);
		this.latch = latch;
		this.query = query;
		this.result = result;
