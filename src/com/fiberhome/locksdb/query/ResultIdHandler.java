...
public class ResultIdHandler extends LocksQuery implements Runnable {
	private static Logger logger = LoggerFactory.getLogger(ResultIdHandler.class);
	private RocksIdQuery queryid = null;
	...
	public ResultIdHandler(CountDownLatch latch, RocksIdQuery query, LinkedBlockingQueue<byte[]> result, LinkedList<Pair<String, Integer>> index, LinkedBlockingQueue<String> response, String rid) {
		super(rid);
		this.latch = latch;
		this.queryid = query;
		this.result = result;
